...
class Programm: # основной класс с информацией по игре и инициализирующий необходимые материалы (музыка, картинки)
    def __init__(self, m_vol, m_on):
        ...
        self._FONT = "C:\Game\images/font\Jost-Light.ttf"
        ...
        self._book_repos = "C:\Game/book"

        self.sprites.addSprite("main_menu_bg", "C:\Game\images/backgrounds\main_bg.png")
        self.sprites.addSprite("main_menu", "C:\Game\images\system\main_menu.png")
        self.sprites.addSprite("settings", "C:\Game\images\system\game_menu.png")
        self.sprites.addSprite("btn_left_normal", "C:\Game\images/button\page_button_left_idle.png")
        self.sprites.addSprite("btn_left_hover", "C:\Game\images/button\page_button_left_hover.png")
        self.sprites.addSprite("btn_right_normal", "C:\Game\images/button\page_button_right_idle.png")
        self.sprites.addSprite("btn_right_hover", "C:\Game\images/button\page_button_right_hover.png")
        self.sprites.addSprite("choice_normal", "C:\Game\images/button\choice_idle_background.png")
        self.sprites.addSprite("choice_hover", "C:\Game\images/button\choice_hover_background.png")
        self.sprites.addSprite("frame", "C:\Game\images\system/frame.png")
        self.sprites.addSprite("divider_up", "C:\Game\images\system\dividerUp.png")
        self.sprites.addSprite("divider_down", "C:\Game\images\system\dividerDown.png")
        self.sprites.addSprite("namebox", "C:\Game\images\system/namebox.png")

        self.sprites.addSprite("railway_station", "C:\Game\images/backgrounds/railway.png")
        self.sprites.addSprite("restaurant", "C:\Game\images/backgrounds/restaurant.png")
        self.sprites.addSprite("restaurant2", "c:\Game\images/backgrounds/restaurant2.png")
        self.sprites.addSprite("train1", "C:\Game\images/backgrounds/train1.png")
        self.sprites.addSprite("train2", "C:\Game\images/backgrounds/train2.png")
        self.sprites.addSprite("train3", "C:\Game\images/backgrounds/train3.png")
        self.sprites.addSprite("train4", "C:\Game\images/backgrounds/train4.png")
        self.sprites.addSprite("train5", "C:\Game\images/backgrounds/train5.png")
        self.sprites.addSprite("universe", "C:\Game\images/backgrounds/uni.png")
        self.sprites.addSprite("hotel", "C:\Game\images/backgrounds\hotel_rest.png")

        self.sprites.addSprite("Пуаро", "c:\Game\Characters\Puaro.png")
        self.sprites.addSprite("Доктор Константин", "c:\Game\Characters\\test_man.png")
        self.sprites.addSprite("Бук", "c:\Game\Characters\\test_man.png")
        self.sprites.addSprite("Дебенхэм", "c:\Game\Characters\\test_woman.png")
        self.sprites.addSprite("Арбэтнот", "c:\Game\Characters\\test_man.png")
        self.sprites.addSprite("Маккуин", "c:\Game\Characters\\test_man.png")
        self.sprites.addSprite("Фоскарелли", "c:\Game\Characters\\test_man.png")
        self.sprites.addSprite("Рэтчетт", "c:\Game\Characters\\test_man.png")
        self.sprites.addSprite("Мастермэн", "c:\Game\Characters\\test_man.png")
        self.sprites.addSprite("Мишель", "c:\Game\Characters\\test_man.png")
        self.sprites.addSprite("Княгиня Драгомирова", "c:\Game\Characters\\test_woman.png")
        self.sprites.addSprite("Шмидт", "c:\Game\Characters\\test_woman.png")
        self.sprites.addSprite("Граф Андрени", "c:\Game\Characters\\test_man.png")
        self.sprites.addSprite("Графиня Андрени", "c:\Game\Characters\\test_woman.png")
        self.sprites.addSprite("Ольсон", "c:\Game\Characters\\test_woman.png")
        self.sprites.addSprite("Миссис Хаббард", "c:\Game\Characters\\test_woman.png")
        self.sprites.addSprite("Хардман", "c:\Game\Characters\\test_man.png")
        
        self.music.addMusic("main_music", "C:\Game\music/Night on the Docks - Trumpet.mp3")
        self.music.addMusic("railway_ambient", "C:\Game\music/railway.mp3")
        self.music.addMusic("backbay", "C:\Game\music/Backbay Lounge.mp3")
        self.music.addMusic("just_soon", "C:\Game\music\Just As Soon.mp3")
        self.music.addMusic("restaurant_ambient", "C:\Game\music/restaurant_ambient.mp3")
        self.music.addMusic("boiled", "c:\Game\music\Hard Boiled.mp3")
        self.music.addMusic("cool_side", "c:\Game\music\On the Cool Side.mp3")
        self.music.addMusic("walking", "c:\Game\music\Walking Along.mp3")
        self.music.addMusic("ground", "c:\Game\music\On the Ground.mp3")
        self.music.addMusic("vibes", "c:\Game\music\Cool Vibes.mp3")
